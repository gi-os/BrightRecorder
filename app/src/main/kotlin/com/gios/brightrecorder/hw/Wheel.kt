 ...
 *
 * Public because the tape screen wants the notches themselves rather than a scroller: there the
 * wheel drives the speed of the tape, and the whole point is that it is *not* a scroll position.
 * [WheelScroll] is this plus a debt and a scroller, and the list screen uses that instead.
 */
@Composable
fun WheelNotches(active: Boolean, onNotch: (Int) -> Unit) {
