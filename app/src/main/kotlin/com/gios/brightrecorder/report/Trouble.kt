package com.gios.brightrecorder.report
 ...
 * ordinary never arrive at all. In this app the quiet failure is the expensive one: a microphone
 * that never opened looks exactly like a microphone recording an empty room, and by the time
 * anyone notices, the moment it was pointed at has gone and cannot be recorded again.
 *
 * **The nagging is the thing to get right.** A microphone another app is holding fails on every
 * attempt, and an app that asks to report it twelve times before lunch gets its reporting turned
