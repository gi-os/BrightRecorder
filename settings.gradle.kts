...
dependencyResolutionManagement {
    ...
    repositories {
        ...
        //
        // gi-os/BrightCommon, not gi-os/light-common: the repo was renamed. Reads redirect either
        // way, but pointing at the real name saves the next person the detour.
        maven {
...
rootProject.name = "BrightRecorder"
include(":app")
