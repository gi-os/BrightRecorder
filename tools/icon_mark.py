#!/usr/bin/env python3
"""Build BrightRecorder's launcher mark.
...
MARK = [
    ('M25.00,32.00 H83.00 A5.00,5.00 0 0 1 88.00,37.00 V71.00 A5.00,5.00 0 0 1 83.00,76.00 H25.00 A5.00,5.00 0 0 1 20.00,71.00 V37.00 A5.00,5.00 0 0 1 25.00,32.00 Z', 5, False),
    ('M31.00,50.00 A9.00,9.00 0 1 1 49.00,50.00 A9.00,9.00 0 1 1 31.00,50.00 Z', 4, False),
    ('M59.00,50.00 A9.00,9.00 0 1 1 77.00,50.00 A9.00,9.00 0 1 1 59.00,50.00 Z', 4, False),
    ('M37.00,50.00 A3.00,3.00 0 1 1 43.00,50.00 A3.00,3.00 0 1 1 37.00,50.00 Z', 0, False),
    ('M65.00,50.00 A3.00,3.00 0 1 1 71.00,50.00 A3.00,3.00 0 1 1 65.00,50.00 Z', 0, False),
    ('M28,64 H80', 4, False),
    ('M37.50,70.00 A2.50,2.50 0 1 1 42.50,70.00 A2.50,2.50 0 1 1 37.50,70.00 Z', 0, False),
    ('M51.50,70.00 A2.50,2.50 0 1 1 56.50,70.00 A2.50,2.50 0 1 1 51.50,70.00 Z', 0, False),
    ('M65.50,70.00 A2.50,2.50 0 1 1 70.50,70.00 A2.50,2.50 0 1 1 65.50,70.00 Z', 0, False),
]
...
<!--
  BrightRecorder launcher mark. One of the unified Bright* set: 108 canvas, 18..90
